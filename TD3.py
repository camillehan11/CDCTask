...
class TD3_agent(object):
	...
	def choose_action(self, state,k):
		self.actor.eval()
	...
	def learn(self):
		...
		state, action, reward, next_state = self.memory.sample_batch(self.batch_size)
		...
		action = torch.cat((action,action,action,action,action,action,action,action,action,action,action,action,action,action,action,action,action,action,action,action), dim=1)
